...
class RecordingViewModel : ViewModel() {
    ...
    private val _trackFinished = MutableLiveData<Boolean>()
    val trackFinished: LiveData<Boolean> = _trackFinished
    ...
    fun finishTrack(trackId: String) {
        viewModelScope.launch {
            _trackFinished.value = true
        }
    }
}
